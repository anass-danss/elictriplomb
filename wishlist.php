...
<head>
    ...
    <title>Plumer - Plumbing & Repair HTML Template - Wishlist</title>
            ...
            <div class="container themeholy-container">
                <div class="row justify-content-center justify-content-lg-between align-items-center gy-2">
                    <div class="col-auto d-none d-lg-block">
                        <p class="header-notice">Welcome to <span class="text-theme">Plumer</span> Plumbing & Repairing Service.</p>
                    </div>
                    <div class="col-auto">
                        <div class="header-links">
                            <ul>
                                <li><i class="fal fa-phone"></i><a href="tel:+16326543654">+163-2654-3654</a></li>
                                <li><i class="fal fa-envelope"></i><a href="mailto:info@plumer.com">info@plumer.com</a></li>
                                <li><i class="fal fa-location-dot"></i><a href="https://www.google.com/maps">Santa Rosa, United States</a></li>
                                <li><i class="fal fa-clock"></i>Work Time: Mon - Fri 09AM - 6PM</li>
                                <li>
                        ...
                        <tbody>
                            <tr class="wishlist_item">
                                ...
                                <td class="product-thumbnail">
                                    <a href="shop-details.html"><img src="assets/img/product/product_thumb_1_1.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image"></a>
                                </td>
                                <td class="product-name">
                                    <a href="shop-details.html">Switches Breaker</a>
                                </td>
                                ...
                                <td class="product-action">
                                    <button class="button themeholy-btn" name="tinvwl-add-to-cart" value="58" title="Add to Cart">
                            ...
                            <tr class="wishlist_item">
                                ...
                                <td class="product-thumbnail">
                                    <a href="shop-details.html"><img src="assets/img/product/product_thumb_1_2.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image"></a>
                                </td>
                                <td class="product-name">
                                    <a href="shop-details.html">Bathroom Sink Tap</a>
                                </td>
                                <td class="product-price">
                                ...
                                <td class="product-action">
                                    <button class="button themeholy-btn" name="tinvwl-add-to-cart" value="60" title="Add to Cart">
                                        <i class="fal fa-shopping-cart"></i><span class="tinvwl-txt">Add to Cart</span>
                                    </button>
                                </td>
                            </tr>
                            <tr class="wishlist_item">
                                ...
                                <td class="product-thumbnail">
                                    <a href="shop-details.html"><img src="assets/img/product/product_thumb_1_3.jpg" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="image"></a>
                                </td>
                                <td class="product-name">
                                    <a href="shop-details.html">Villeroy & Boch Sink</a>
                                </td>
                                <td class="product-price">
                                    <ins><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>18.00</bdi></span></ins>
                                    <del><span class="woocommerce-Price-amount amount"><bdi><span class="woocommerce-Price-currencySymbol">$</span>20.00</bdi></span></del>
